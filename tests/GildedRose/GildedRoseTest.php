...
class GildedRoseTest extends TestCase
{
    ...
    {
        $item = GildedRose::of('normal', 10, 5); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('normal', 10, 0); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('normal', 0, 5); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('Aged Brie', 10, 5); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('Aged Brie', 50, 5); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('Aged Brie', 10, 0); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('Aged Brie', 49, 0); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('Aged Brie', 50, 0); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('Aged Brie', 10, -10); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('Aged Brie', 50, -10); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('Sulfuras, Hand of Ragnaros', 10, 5); // name, quality, sell in x days
    ...
    {
        $item = GildedRose::of('Sulfuras, Hand of Ragnaros', 10, -1); // name, quality, sell in x days
